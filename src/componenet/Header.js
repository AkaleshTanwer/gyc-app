            ...
            <nav>
                ...
                <div className="content">
                    ...
                    <ul className="links">
                        ...
                        <li>
                            <Link to={"#"} className="desktop-link dropdown-toggle">Colleges </Link>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li><Link to="/collegelist">B.sc</Link></li>
                                        <li><Link to="/collegelist">B.com</Link></li>
                                        <li><Link to="/collegelist">B.Tech</Link></li>
                                        <li><Link to="/collegelist">B.Tech</Link></li>
                                        <li><Link to="/collegelist">B.Tech</Link></li>
                                        <li><Link to="/collegelist">B.Tech</Link></li>
                                        <li><Link to="/collegelist">B.Tech</Link></li>
                        ...
                        <li>
                            <Link to="#" className="desktop-link dropdown-toggle">Exams </Link>
                            <input type="checkbox" id="show-services" />
                            <label htmlFor="show-services">Exams</label>
                            <ul>
                                <li>
                                    <Link to="/exams" className="desktop-link dropdown-toggle"> UG </Link>
                                    <input type="checkbox" id="show-items" />
                                    <label htmlFor="show-items">UG Exam Details</label>
                                    <ul>
                                ...
                                <li>
                                    <Link to="/exams" className="desktop-link dropdown-toggle"> PG</Link>
                                    <input type="checkbox" id="show-items" />
                                    <label htmlFor="show-items">UG Exam Details</label>
                                    <ul>
                                        <li><Link to="/">Sub Menu 1</Link></li>
